...
import 'package:insta_clone_firebase/widgets/follow_button.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
                            ...
                            child: Column(
                              children: [
                                Row(
                                  ...
                                  children: [
                                    buidlStatColumn(postLen, "posts"),
                                    buidlStatColumn(followers, "followers"),
                                    buidlStatColumn(following, "following"),
                                  ],
                                ),
  ...
  Column buidlStatColumn(int num, String label) {
    return Column(
